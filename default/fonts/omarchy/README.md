...
- `U+E90A` — Dim Agent, traced from the app icon at <https://dimcode.dev/apple-touch-icon.png>, since upstream publishes no monochrome SVG
- `U+E90B` — Kimi Code, from <https://simpleicons.org/icons/kimi.svg>
