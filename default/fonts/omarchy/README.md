...
- `U+E90A` — OpenClaw, from <https://fontawesome.com/icons/shrimp> (CC BY 4.0), standing in for the lobster OpenClaw uses as its favicon: that one is five paths under a gradient, and its silhouette alone does not read
