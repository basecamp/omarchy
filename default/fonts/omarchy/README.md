...
- `U+E90A` — NetBird, flattened from <https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/netbird.svg>, since NetBird publishes no monochrome single-path mark
