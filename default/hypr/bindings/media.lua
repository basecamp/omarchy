-- Volume, brightness, keyboard backlight, camera and touchpad controls.
...
hl.bind("XF86WebCam", hl.dsp.exec_cmd("omarchy-toggle-webcam"), { locked = true, description = "Toggle camera privacy" })
