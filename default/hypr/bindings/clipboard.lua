...
o.bind(omarchy_bindings.universal_copy, "Universal copy", universal_clipboard_shortcut("CTRL",  "C",  "CTRL",  "Insert"))
o.bind(omarchy_bindings.universal_paste, "Universal paste", universal_clipboard_shortcut("CTRL",  "V",  "SHIFT",  "Insert"))
o.bind(omarchy_bindings.universal_cut, "Universal cut", send_shortcut_once("CTRL",  "X"))
o.bind(omarchy_bindings.clipboard_manager, "Clipboard manager", "omarchy-shell shell toggle omarchy.clipboard")
