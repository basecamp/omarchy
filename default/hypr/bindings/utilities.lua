...
o.bind("SUPER + ALT + code:20", "Make webcam overlay smaller", "omarchy-capture-webcam-resize smaller")
o.bind("SUPER + ALT + code:21", "Make webcam overlay larger", "omarchy-capture-webcam-resize larger")
