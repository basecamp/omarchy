...
# Wondering if i should have it check for certain SSID's. And for the RV for instance
# should go to the HASS instance, where it gets the GPS coordinates from Hardware.
