...
MouseArea {
  ...
  Binding { target: root.child; property: "x"; value: root.leftMargin + root.extraMargin; when: root.child !== null }
  Binding { target: root.child; property: "y"; value: root.topMargin + root.extraMargin; when: root.child !== null }
  Binding {
    target: root.child
    property: "width"
