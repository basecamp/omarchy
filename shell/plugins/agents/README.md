...
| `grok` | Grok CLI-proxy billing (`/v1/billing?format=credits`) plus `subscription_tier_display` from `/v1/settings` | `turn_completed` usage in `~/.grok/sessions/*/updates.jsonl` |
