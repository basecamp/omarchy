...
if (( $(id -u) != 0 )) && [[ $(mbp15_logind_dest) == /etc/* ]]; then
  exec sudo --preserve-env=OMARCHY_PATH,OMARCHY_DMI_PRODUCT_NAME,OMARCHY_MBP15_LOGIND,OMARCHY_MBP15_SLEEP,OMARCHY_MBP15_UDEV_SRC,OMARCHY_MBP15_UDEV_DEST,OMARCHY_MBP15_UNIT_SRC,OMARCHY_MBP15_UNIT_DEST,OMARCHY_MBP15_SKIP_SYSTEMCTL \
