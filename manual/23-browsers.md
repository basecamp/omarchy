...
**Subscribe to Feeds** discovers the RSS or Atom feed advertised by the current page and adds it to [Feeds](21-tuis.md) with `Alt + Shift + R`. You do not need to hunt through the page source or copy a special feed address. If Feeds is not installed yet, the notification offers to install it.
