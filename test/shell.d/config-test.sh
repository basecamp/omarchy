...
package_defaults = [
  ...
  ("default/systemd/user/omarchy-brightness-keyboard-watch.service", "/usr/lib/systemd/user/omarchy-brightness-keyboard-watch.service", "systemd/user/omarchy-brightness-keyboard-watch.service"),
