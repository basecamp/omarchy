...
colour_only=(btop.theme chromium.theme claude.json helix.toml hyprland-preview-share-picker.css keyboard.rgb obsidian.css omp.json pi.json shell.toml vscode-theme.json)
