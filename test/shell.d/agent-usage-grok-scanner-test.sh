...
# SuperGrokPlus is the live SuperGrok tier; keep the brand together.
plus=$(probe_record "$billing" '{"subscriptionTier":"SuperGrokPlus"}' force)
...
subscription=$(probe_record '{"config":{"currentPeriod":{"type":"USAGE_PERIOD_TYPE_WEEKLY","end":"2026-08-15T14:46:02.562637+00:00"},"creditUsagePercent":0.4,"prepaidBalance":{"val":0},"onDemandCap":{"val":0},"onDemandUsed":{"val":0}}}' '{"subscriptionTier":"SuperGrokPlus"}' force)
