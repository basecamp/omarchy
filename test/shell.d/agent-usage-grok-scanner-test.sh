...
{"config":{"currentPeriod":{"type":"USAGE_PERIOD_TYPE_WEEKLY","start":"2026-08-06T02:33:55.961189+00:00","end":"2026-08-13T02:33:55.961189+00:00"},"creditUsagePercent":10.0,"onDemandCap":{"val":0},"onDemandUsed":{"val":0},"productUsage":[{"product":"GrokChat","usagePercent":10.0}],"isUnifiedBillingUser":true}}
EOF
...
[[ $(jq -r '.limits[0].resetsAt' <<<"$billing") == "2026-08-13T02:33:55Z" ]] ||
