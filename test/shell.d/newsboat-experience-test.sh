...
grep -Fq 'macro b set browser "omarchy-newsboat-brief --from-newsboat"' "$ROOT/default/newsboat/omarchy.conf" || fail "Feeds exposes the whole-edition agent briefing"
